...
namespace Program
{
    class Program
    {
        static void Main(string[] args)
        {
...
#if true
            TDBDataSource tdbSource = new TDBDataSource("114.80.154.34", "6271", "W59289091558", "85638978", 30, 1, 1);
            ...
            //测试获取TICK
            {
                TDBReq reqTick = new TDBReq("600000.sh", "SH-2-0", 20151210);
                TDBTick[] tickArr;
            ...
            //测试指数字段
            {
                TDBReq reqTick = new TDBReq("000300.SH", "SH-2-0", 20151210);
                TDBTick[] tickArr;
                TDBErrNo nErrInner = tdbSource.GetTick(reqTick, out tickArr);
                if (nErrInner == TDBErrNo.TDB_SUCCESS)
                {
